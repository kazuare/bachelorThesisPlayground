...
public class GraphBuilding {
	...
	public static SimpleWeightedGraph<Vertex,Edge> getColoredGraph(){				
			...
			List<Integer> bannedVertices = Arrays.asList(new Integer[]{
					...
					195300201, 194045901, 144770801, 145415601,
					144745901
					});
	...
	public static Pair<Edge, Vertex> findEdgeAndPointToDelete(WeightedGraph<Vertex,Edge> graph) {
		...
		while (edgeIterator.hasNext()) {
			...
			boolean aCannotBeDeleted = graph.edgesOf(e.a).size() == 1 || e.a.pumpStationEntry || e.a.pumpStationExit || e.a.betweenSectorBlock || e.a.southernPumpStation || e.a.type.toLowerCase().contains("ÍÓÎÓ‰Âˆ");
			boolean bCannotBeDeleted = graph.edgesOf(e.b).size() == 1 || e.b.pumpStationEntry || e.b.pumpStationExit || e.b.betweenSectorBlock || e.b.southernPumpStation || e.b.type.toLowerCase().contains("ÍÓÎÓ‰Âˆ");				
